					...
					<div class="fotos">
						...
						<div class="modal">
						    <div class="modal_content">
						        <img src="/200966315_EvandroSouzaRocha/img/docinho-tapioca.jpg" id="modal_img">
						    </div>
						    ...
						    <div class="container">
						        <div class="row">
						            <div class="card_img">
						                <img src="/200966315_EvandroSouzaRocha/img/docinhos-de-tapioca.jpg" class="small_img">
						            </div>
						...
						<div class="descricao_produto">
							<div class="titulo_descricao">
								<h2 class="tit_desc">Docinhos de tapioca</h2>
							</div> <!-- fim div titulo descrição -->

							<div class="descricao_produto_texto">
								<br>Tapioca é um ingrediente superversátil que conquistou o Brasil inteiro!<br/> Muitas pessoas já começam o dia com uma deliciosa tapioca recheada no café da manhã, e é possível fazer diversas receitas com a farinha de tapioca.<br/>
